...
if ( ! file_exists( __DIR__ . '/vendor/autoload.php' ) ) {
	add_action( 'admin_notices', function() {
		echo '<div class="error"><p>' . esc_html__( 'WP WebDav Media Library error: The "vendor" folder is missing. Please run "composer install" or download the full release package with dependencies.', 'wp-webdav-media-library' ) . '</p></div>';
	} );
	return;
}
...
if ( ! class_exists( 'Sabre\DAV\Client' ) ) {
	add_action( 'admin_notices', function() {
		echo '<div class="error"><p>' . esc_html__( 'WP WebDav Media Library error: The SabreDAV library is not loaded. The "vendor" folder might be incomplete.', 'wp-webdav-media-library' ) . '</p></div>';
	} );
	return;
}
