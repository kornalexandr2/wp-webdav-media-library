...
class WebDav extends Service_Base implements Service {
	...
	public function get_directory_listing( string $directory ): array {
		...
		if ( $directory !== $this->directory && strlen( $directory ) < strlen( $this->directory ) ) { // @phpstan-ignore property.notFound,property.notFound
			$directory = $this->directory; // @phpstan-ignore property.notFound
		}
